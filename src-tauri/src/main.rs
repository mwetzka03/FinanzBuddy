...
fn main() {
  tauri::Builder::default()
    ...
    .invoke_handler(tauri::generate_handler![
      ...
      commands::ledger::update_transfer,
      commands::ledger::delete_transfer,
      commands::ledger::convert_transfer_to_ledger,
      commands::ledger::convert_ledger_to_transfer,
      ...
      commands::fixed_costs::dismiss_fixed_cost_occurrence,
      commands::fixed_costs::list_fixed_cost_dismissed_occurrences,
